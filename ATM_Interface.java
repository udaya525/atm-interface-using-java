...
public class ATM_Interface{
    ...
    public void View_Profile(){
	    ...
	    System.out.println("Mobile Number: "+this.Phone_Number);
	}
    public void Register(){
        ...
        while((Pin.length())!=4){
            System.out.print("! Please Enter Valid 4 Digit Pin Number: ");
            this.Pin=input.nextLine();
        }
        ...
        System.out.println("Congratulations! Your are Successfully Registered");
    ...
    public void Deposit(){
        System.out.print("Kindly Enter the amount to deposit into your Account : ");
	    ...
	    System.out.println("Please Enter Amount Below 5,00,000/-");
        }
        else{
        ...
        if(choice==1){
            ...
            while(choice==1){
                ...
                if (option==1){
                    if(atm.Login()){
                        while(true){
                            System.out.println("\n\nYou can perform the following operaions via this ATM: ");
                            ...
                            switch(select){
                                ...
                                case 7 :System.out.println("\nThank you...Visit Again...:)"); 
                                        System.exit(0);
                                default: System.out.println("Invalid option!...Kindly Enter Valid option...");
                            }
                        }
                    }
                }
